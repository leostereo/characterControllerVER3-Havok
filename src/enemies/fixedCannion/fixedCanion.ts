...
export class FixedCanionEnemy {
  ...
  constructor(
    ...
    const { barrelPivot, muzzleMesh, bodyMesh, searchLight, bodyAggregate } =
  ...
  private buildCanionGeometry(): {
    ...
    const searchLight      = new PointLight("canio_search_light", this.position.clone(), this.scene);
    ...
    return { barrelPivot, muzzleMesh, bodyMesh, searchLight, bodyAggregate };
  }
